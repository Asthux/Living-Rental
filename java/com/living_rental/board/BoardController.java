package com.living_rental.board;
...
import com.living_rental.board.service.IBoardService;
...
public class BoardController {
	...
	public String boardProc(Model model, 
		...
		return "forward:/home?formpath=board";
	}
	...
	public String viewProc(@RequestParam(value = "writeNo", required = false) String writeNo, Model model) {
		...
		service.upHit(no);
		return "forward:/home?formpath=view";
	}
	...
	public String modifyProc(BoardDTO board) {
		...
		if(check == false) {
			return "forward:home?formpath=modify";
		}
		return "forward:boardProc";
	}
